...
(function () {
  ...
  const DEFAULT_PREDICTIONS_DATA = [
    {
      ...
      lat: 12.91274, lon: 80.104416, is_rob: false, distance_meters: 9500, eta_seconds: 657,
    ...
    },
    {
      ...
      lat: 12.8774, lon: 80.07705, is_rob: false, distance_meters: 7300, eta_seconds: 505,
      status: 'OPEN - PROBABILISTIC SAFETY BUFFER', status_code: 'OPEN', status_level: 'green', status_symbol: '🟢',
    ...
    },
    {
      ...
      lat: 12.855336, lon: 80.064196, is_rob: false, distance_meters: 4600, eta_seconds: 318,
    ...
    },
    {
      ...
      lat: 12.832379, lon: 80.046687, is_rob: false, distance_meters: 2500, eta_seconds: 173,
    ...
    },
    {
      ...
      lat: 12.819258, lon: 80.035599, is_rob: false, distance_meters: 240, eta_seconds: 16,
    ...
    },
    {
      ...
      lat: 12.808982, lon: 80.028541, is_rob: false,
    ...
    },
    {
      ...
      lat: 12.801202, lon: 80.023541, is_rob: false, distance_meters: 850, eta_seconds: 58,
      status: 'CLOSED - TRAIN PASSING IMMINENT', status_code: 'CLOSED', status_level: 'red', status_symbol: '🛑',
    ...
    },
    {
      ...
      lat: 12.778741, lon: 80.009996, is_rob: false, distance_meters: 3700, eta_seconds: 256,
      status: 'APPROACHING - BARRIER CLOSURE PENDING', status_code: 'APPROACHING', status_level: 'yellow', status_symbol: '⏳',
    ...
    },
    {
      ...
      lat: 12.746, lon: 79.9923, is_rob: false, distance_meters: 7100, eta_seconds: 491,
      status: 'OPEN - PROBABILISTIC SAFETY BUFFER', status_code: 'OPEN', status_level: 'green', status_symbol: '🟢',
    ...
    },
    {
      ...
      lat: 12.71175, lon: 79.9819, is_rob: false, distance_meters: 10800, eta_seconds: 747,
      status: 'OPEN - PROBABILISTIC SAFETY BUFFER', status_code: 'OPEN', status_level: 'green', status_symbol: '🟢',
    ...
    },
    {
      ...
      lat: 12.880184, lon: 80.07843, is_rob: true, distance_meters: 0, eta_seconds: 0,
  ...
  function initMap() {
    ...
    if (btnSpotLC57) {
      btnSpotLC57.addEventListener('click', () => {
        if (map) {
          map.flyTo([12.819258, 80.035599], 16, { duration: 0.8 });
  ...
  async function triggerSimPassingLC57() {
    ...
    try {
      ...
      if (map) {
        map.flyTo([12.819258, 80.035599], 16, { duration: 1.0 });
        if (gateMarkers['LC57']) {
  ...
  function initSpotlightControls() {
    ...
    function focusLC57() {
      if (map) {
        map.flyTo([12.819258, 80.035599], 15, { duration: 1.0 });
        if (gateMarkers['LC57']) {
          gateMarkers['LC57'].openTooltip();
        }
